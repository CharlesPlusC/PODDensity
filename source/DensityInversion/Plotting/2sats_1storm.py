...
# Load data
tsx_storm_path = "output/DensityInversion/PODDensityInversion/Data/StormAnalysis/TerraSAR-X/TerraSAR-X_storm_density_9_1_20240511214320.csv"
gfo_storm_path = "output/DensityInversion/PODDensityInversion/Data/StormAnalysis/GRACE-FO/GRACE-FO_storm_density_22.csv"
...
tsx_storm_df.loc['2023-04-23 21:37':'2023-04-23 22:25', 'Computed Density'] = median_density_tsx
...
# tsx_mape = (abs(tsx_storm_df['Computed Density'] - tsx_storm_df['AccelerometerDensity']) / tsx_storm_df['AccelerometerDensity']).mean() * 100
...
common_ylim = (1e-13, 5e-12)

fig, ax = plt.subplots(2, 1, figsize=(10, 10))

# Top subplot: TerraSAR-X and GRACE-FO densities with MAPE in legend
ax[0].plot(gfo_storm_df.index, gfo_storm_df['AccelerometerDensity'], label="Accelerometer Density: GFO")
ax[0].plot(gfo_storm_df.index, gfo_storm_df['Computed Density'], label=f"POD Density: GFO (MAPE={gfo_mape:.2f}%)")
ax[0].plot(tsx_storm_df.index, tsx_storm_df['Computed Density'], label=f"POD Density: TSX (MAPE=None)")
ax[0].set_title("Accelerometer vs POD Density")
...
ax[1].plot(gfo_storm_df.index, gfo_storm_df['AccelerometerDensity'], label="Accelerometer Density: GFO")
ax[1].plot(gfo_storm_df.index, gfo_storm_df['JB08'], label=f"JB08 (MAPE={jb08_mape:.2f}%)")
ax[1].plot(gfo_storm_df.index, gfo_storm_df['DTM2000'], label=f"DTM2000 (MAPE={dtm2000_mape:.2f}%)")
ax[1].plot(gfo_storm_df.index, gfo_storm_df['NRLMSISE-00'], label=f"NRLMSISE-00 (MAPE={nrlmsise_mape:.2f}%)")
ax[1].set_title("Accelerometer vs Model Density")
